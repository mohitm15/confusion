...
class Contact extends Component {
    ...
    // checking that form is touched by user or not, if touched: field => true
                             ...
                             <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" id="firstname" name="firstname"
                                        ...
                                        value={this.state.firstname}    //passing state values
                                        valid={errors.firstname === ''} //default value (green tick in view)
                                        invalid={errors.firstname !== ''}
                                        onBlur={this.handleBlur('firstname')} //checking for touched
                                        onChange={this.handleInputChange} />    {/*setState the value with coreesponding field name*/}
                                    <FormFeedback>{errors.firstname}</FormFeedback> {/**displaying validations */}
                                </Col>
                            </FormGroup>
                            <FormGroup row>
